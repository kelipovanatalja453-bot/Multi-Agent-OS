> ⚠️ PRE-VALIDATION DRAFT
>
> This document represents early design thinking and has NOT been validated
> through real-world use. Many claims here may be revised or invalidated when
> the framework is tested in actual multi-agent projects (planned Jun-Jul 2026).
>
> For the current minimal version, see
> plugin/vibe-agent/skills/core-coordination/SKILL.md
